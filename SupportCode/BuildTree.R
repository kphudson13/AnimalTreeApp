...
# If you run this again it will cause a world of pain. OTOL has updated the taxonomy.
# Collapsing nodes dont line up with new taxonomy. 
# From here on out i take the tree saved at the bottom of this commented script
...
tree <- AddTip(tree, where = "Thaliacea", label = "Salpida", edgeLength = 1)
...
tree <- drop.tip(tree, "Thaliacea")

pairs_to_collapse <- list(c("Ascidiacea", "Larvacea"))
...
write.nexus(tree, file = "AnimalTreeApp/tree_updated.nex")
